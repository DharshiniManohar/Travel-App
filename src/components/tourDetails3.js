...
import '../styles/tourDetails3.css';
import one from '../assets/logo.png';

function TourDetails3() {
  // Initial prices
  ...
  return (
    <div>
      ...
      <div className="d-tour-content">
        <h1 className="d-tour-title">Voyages Beyond Borders</h1>
        <h2>Paris| Venice |Rome |Lucerne</h2>

        <div className="d-tour-description">
          <img
            src="https://media.cntraveller.com/photos/653783ab9da3a22eb97452f9/16:9/w_1920,c_limit/Cheapest_time_to_go_to_Paris_October23_Getty_Images.jpg"
