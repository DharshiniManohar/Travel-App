  ...
  return (
    <div>
      ...
      <div className="d-tour-content">
        <h1 className="d-tour-title">Premium visit to South India</h1>
        <h2>Mahabalipuram|Alleppey|Ooty|Mysore</h2>

        <div className="d-tour-description">
          <img
            src="https://miro.medium.com/v2/resize:fit:1400/1*O40cCSsckUi6YfxBFU2pXg.png"
